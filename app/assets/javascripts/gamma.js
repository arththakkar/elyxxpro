	...
	var $window = $( window ),
		...
		_createSingleViewNavigation = function() {
			...
			if( Gamma.itemsCount > 1 ) {
				...
				Gamma.cast = $( '<div class="col-sm-6 signup text-right float-right mt-3 mr-3"><h2><a href="javascript:void(0)" data-url="" data-id="" id="castId" onclick="castMe(\'https://www.dropbox.com/s/2rh7inz8s7supds/pontrelli_07.jpg?raw=1\', this)">Cast</a></h2></div>' ).insertAfter( Gamma.svplay );
